 ...
 *
 * <p> server.NanoHTTPD version 1.25,
...
public class NanoHTTPD
{
	...
	{
		myOut.println( "server.NanoHTTPD 1.25 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
	...
	private class HTTPSession implements Runnable
	{
		...
		public void run()
		{
			try
			{
				...
				// Ok, now do the serve()
				Response r = serve( uri, method, header, parms, files, data);
				if ( r == null )
