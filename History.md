2.0.15 / 2022-??-??
==================
  * Fix selenium-ide.html in localStorage-file-system example (https://github.com/tntim96/JSCover/issues/303)
  ...
  * Internal: HtmlUnit 2.58.0 to 2.60.0, Mockito 4.3.1 to 4.5.1, JaCoCo 0.8.7 to 0.8.8
