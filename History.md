2.0.24 / 2026-??-??
==================
 * Upgrade closure-compiler v20260128 to v20260804, Rhino 1.9.0 to 1.9.1, GSON 2.13.2 to 2.14.0
 * Internal: Mockito 5.20.0 to 5.23.0, JUnit 4.13.2 to JUnit 6.1.0, Hamcrest 3.0 to AssertJ 3.27.7
 * Internal: HTML Unit 4.21.0 to 5.2.0, JaCoCo 0.8.14 to 0.8.15, Maven Resolver Ant Tasks 1.6.0 to 2.0.0
 ...
 * Internal: HtmlUnit 4.12.0 to 4.15.0, Maven Resolver Ant Tasks 1.5.2 to 1.6.0

2.0.21 / 2025-05-25
==================
 * Java 21 to align with closure-compiler
 * Upgrade closure-compiler v20240317 to v20250407, gson 2.11.0 to 2.13.1
 * Internal: Mockito 5.13.0 to 5.18.0, HtmlUnit 4.4.0 to 4.12.0, Rhino 1.7.15 to 1.8.0
